...
function isKitManagedPath(file) {
  const managedRoots = new Set(['.claude', '.cursor', '.agents', '.codex', '.codex-plugin', '.opencode', '.vibekit']);
...
if (shouldWrite) {
  ...
  console.log('- Writing style: recorded by default - no emoji and no em/en dashes in generated prose; ASCII punctuation only.');
