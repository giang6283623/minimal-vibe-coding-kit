> **Upstream reference**
>
> Adapted from [Mermaid 11.16.0 source](https://github.com/mermaid-js/mermaid/blob/mermaid%4011.16.0/packages/mermaid/src/docs/syntax/radar.md). This kit copy is
...
Please refer to the [configuration](https://github.com/mermaid-js/mermaid/blob/mermaid%4011.16.0/packages/mermaid/src/schemas/config.schema.yaml#L2583-L2635) guide for details.
