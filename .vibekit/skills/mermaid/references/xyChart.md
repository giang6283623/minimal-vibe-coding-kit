> **Upstream reference**
>
> Adapted from [Mermaid 11.16.0 source](https://github.com/mermaid-js/mermaid/blob/mermaid%4011.16.0/packages/mermaid/src/docs/syntax/xyChart.md). This kit copy is
...
### Legend (unreleased upstream; unavailable in Mermaid 11.16.0)

> **Pinned-runtime boundary**
>
> This section came from the imported development snapshot and is absent from the official
> Mermaid 11.16.0 source page. The 11.16.0 renderer accepts named series but does not draw their
> legend. Do not promise a legend unless a later official release documents it and the kit's
> pinned compatibility probe is updated.
