...
Audience: Claude, Cursor, Codex, OpenCode, Grok, Kimi, or any AI coding agent in a repo that just received Minimal Vibe Coding Kit.
...
4. At least one harness folder or config exists: `.claude/`, `.cursor/`, `.agents/`, `.opencode/`, `opencode.json`, `.grok/`, `.kimi-code/`, `.codex/`, or `.codex-plugin/`.
