> **Upstream reference**
>
> Adapted from [Mermaid 11.16.0 source](https://github.com/mermaid-js/mermaid/blob/mermaid%4011.16.0/packages/mermaid/src/docs/syntax/packet.md). This kit copy is
...
Please refer to the [configuration](https://github.com/mermaid-js/mermaid/blob/mermaid%4011.16.0/packages/mermaid/src/schemas/config.schema.yaml#L2450-L2485) guide for details.
