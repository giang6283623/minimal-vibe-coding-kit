---
name: vibekit-init
description: Initialize or repair Minimal Vibe Coding Kit in an existing project. Use for first prompt, backbone.yml setup, CLAUDE.md merge, AGENTS.md merge, Cursor rules setup, Codex skill setup, Grok setup, or Kimi setup. Always show requirements and a diff before writing.
disable-model-invocation: true
argument-hint: target path; profiles claude,cursor,codex,grok,kimi; write yes/no
---
