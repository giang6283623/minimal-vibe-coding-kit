...
2. Run `scripts/agentshield_repo_probe.py` to inventory Claude, Codex, shared skills, hooks, MCP, commands, and repo instruction files.
...
- Claude Code may add a slash-command shim in `commands/security-scan.md` or `.claude/commands/security-scan.md`.
...
4. `.agents/`, `agents/`, `skills/`, `commands/`, `hooks/`
