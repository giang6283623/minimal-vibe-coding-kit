> **Upstream reference**
>
> Adapted from [Mermaid 11.16.0 source](https://github.com/mermaid-js/mermaid/blob/mermaid%4011.16.0/packages/mermaid/src/docs/syntax/mindmap.md). This kit copy is
...
Instructions to add and register tidy-tree layout are present in [Tidy Tree Configuration](config-tidy-tree.md)
