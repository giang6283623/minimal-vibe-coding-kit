> **Upstream reference**
>
> Adapted from [Mermaid 11.16.0 source](https://github.com/mermaid-js/mermaid/blob/mermaid%4011.16.0/packages/mermaid/src/docs/syntax/entityRelationshipDiagram.md). This kit copy is
...
### Subgraphs (unreleased upstream; unavailable in Mermaid 11.16.0)

> **Pinned-runtime boundary**
>
> This section came from the imported development snapshot and is absent from the official
> Mermaid 11.16.0 source page. The 11.16.0 ER parser treats `subgraph` and `end` as entity names
> rather than creating a group. Do not generate this syntax unless a later official release
> documents it and the kit's pinned compatibility probe is updated.
...
The layout of the diagram is handled by [`render()`](https://github.com/mermaid-js/mermaid/blob/mermaid%4011.16.0/docs/config/setup/mermaid/interfaces/Mermaid.md#render). The default layout is dagre.

For larger or more-complex diagrams, you can alternatively apply the ELK (Eclipse Layout Kernel) layout using your YAML frontmatter's `config`. For more information, see [Customizing ELK Layout](https://github.com/mermaid-js/mermaid/blob/mermaid%4011.16.0/packages/mermaid/src/docs/intro/syntax-reference.md#customizing-elk-layout).
